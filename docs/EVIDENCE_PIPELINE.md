...
| Konfidensintervallet ikke gjenfunnet som ett uttrykk | `uncertain`, `confidence_interval` føres ikke som kontrollert | Intervallet er én påstand med tre deler. Nivået må stå inntil stedet der kilden navngir intervallet, og grensene må stå som ett intervalluttrykk der. Tre tall fra tre steder i teksten er ikke ett intervall — «0,4 til 2,6» er dessuten ikke samme påstand med 90 % som med 95 % |
