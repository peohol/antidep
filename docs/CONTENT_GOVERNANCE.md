...
Det semantiske arbeidet utføres av eksterne KI-agenter gjennom en versjonert oppgavekontrakt. Antidep eier oppgaven, bindingen mellom svar og grunnlag, og kontrollene; ingen betalt modell-API er en forutsetning. Hvilken modell et agentledd handler som, registreres av det første svaret i leddet og kan ikke skrives om etterpå — bare avsluttes, med hvem og hvorfor. Generator, kildestøttekontroll og evidensvurdering kan ikke være den samme modellen, og finnes ingen uavhengig modell, stopper kjeden framfor å registrere en kontroll som ikke er uavhengig.
