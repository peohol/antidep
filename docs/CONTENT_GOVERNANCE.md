...
Publisering er eksplisitt og separat. Historikk slettes ikke; foreldelse, tilbaketrekking og rollback skal bevare hendelser og kildegrunnlag. Kandidatmodellen finnes nå: sluttkontrollen registreres mot et forseglet innhold og publiserer ingenting. Publiserings-RPC-en er fortsatt stengt for klientrollene, og åpnes først med publiseringsleveransen.
